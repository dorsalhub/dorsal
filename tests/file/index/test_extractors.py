...
def test_extract_embedding():
    ...
    rec_sparse = {
        "model": "sparse-v1",
        "vector": {"dimensions": 100, "indices": [5, 10], "values": [0.1, 0.2]}
    }
...
def test_extract_geolocation():
    ...
    rec = {
        "properties": {"camera_make": "Sony", "camera_model": "Alpha"}
    }
    fts, eav = registry.extract(schema_id, rec)
