...
def mock_search_index_cmd(mocker):
    ...
    mock_search_local_paginated = mocker.patch(
        "dorsal.api.search.search_local_paginated", 
...
def test_save_local_search_results_ioerror_query_txt(tmp_path, mocker, mock_rich_console):
    ...
    _save_local_search_results("test query", {}, {"warning": "yellow", "success": "green", "primary_value": "blue"}, None, False)
