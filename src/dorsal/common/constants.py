...
ENV_DORSAL_INDEX_ENABLED = "DORSAL_INDEX_ENABLED"
ENV_DORSAL_INDEX_COMPRESSION = "DORSAL_INDEX_COMPRESSION"
ENV_DORSAL_INDEX_COMPRESSION_MODE = "DORSAL_INDEX_COMPRESSION_MODE"
ENV_DORSAL_INDEX_COMPRESSION_LEVEL = "DORSAL_INDEX_COMPRESSION_LEVEL"
...
API_MAX_PAYLOAD_SIZE_BYTES = 500 * 1024 * 1024  # 500 MiB
API_MAX_RECORD_SIZE_BYTES = 15 * 1024 * 1024  # 15 MiB
API_RECORD_HEADROOM_BYTES = 1024 * 1024  # 1 MiB headroom for core record overhea
...
CONFIG_OPTION_ICONS = "icons"
CONFIG_OPTION_BORDERS = "borders"
CONFIG_SECTION_CACHE = "cache"
CONFIG_SECTION_INDEX = "index"
CONFIG_OPTION_ENABLED = "enabled"
CONFIG_OPTION_COMPRESSION = "compression"
CONFIG_OPTION_COMPRESSION_MODE = "compression_mode"
CONFIG_OPTION_COMPRESSION_LEVEL = "compression_level"
...
OPEN_VALIDATION_SCHEMAS_VER = "0.5.0"
...
API_MAX_PAYLOAD_SIZE_BYTES = 500 * 1024 * 1024  # 500 MiB
API_MAX_RECORD_SIZE_BYTES = 15 * 1024 * 1024  # 15 MiB
API_RECORD_HEADROOM_BYTES = 1024 * 1024  # 1 MiB headroom for core record overhead
